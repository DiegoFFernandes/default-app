...
Route::middleware(['auth', 'permission:ver-libera-ordem-comercial'])->group(function () {
    Route::prefix('libera-ordem-comercial')->group(function () {
        ...
        Route::post('remover-borracheiro', [LiberaOrdemComissaoController::class, 'removerBorracheiro'])->name('remover-borracheiro');
    });
});
...
Route::middleware(['auth', 'role:admin|diretoria|gerente comercial|usuario comercial'])->group(function () {
    Route::prefix('tabela')->group(function () {
...
Route::middleware(['auth'])->group(function () {
    Route::prefix('borracharia')->group(function () {
        ...
        Route::post('save-parm-borracheiro', [VendedorBorrachariaController::class, 'saveParmBorracheiro'])->name('save-parm-borracheiro');

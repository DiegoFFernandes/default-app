...
Route::middleware(['auth', 'permission:ver-estoque-negativo'])->prefix('estoque')->group(function () {
...
Route::middleware(['auth', 'permission:ver-contagem-estoque'])->prefix('estoque-entrada')->group(function () {

{{-- Cabeçalho da NFS-e (Ponta Grossa). Repetido no topo de CADA página pela
     paginação manual do layout-nota-atz-emp-3. Usa $tomador, $nota, $municipio,
     $prestador do escopo pai. --}}
...
<table class="tb canhoto">
    <tr>
        <td class="p-0">
            <table class="tb">
                <tr>
                    ...
                    <td style="width: 35%">Cód. {{ $tomador->codigo }}</td>
                </tr>
                <tr>
            ...
            <table class="tb bt">
                <tr>
                    <td class="br" style="width: 28%; height: 50px;"><strong>Data de Recebimento</strong></td>
        ...
        <td class="bl" style="width: 17%">
            ...
            <div class="pt-2">RPS: <strong>{{ $nota->dps }}</strong></div>
...
{{-- CABEÇALHO: BRASÃO + MUNICÍPIO + QUADRO DA NOTA --}}
<table class="tb">
    <tr>
        ...
        <td class="text-center" style="width: 50%; vertical-align: top;">
            <div class="fs-14"><strong>{{ $municipio->nome }}</strong></div>
            <div class="fs-12">{{ $municipio->secretaria }}</div>
            <div class="fs-12"><strong>Nota Fiscal de Serviços Eletrônica - NFS-e</strong></div>
        </td>
        <td class="p-0" style="width: 35%; vertical-align: top;">
            <table class="tb quadro quadro-info-nota">
                <tr>
                    <td class="br bb text-center" style="width: 50%; vertical-align: middle;">
                        <div>Nº da Nota:</div>
                        <div class="fs-13"><strong>{{ $nota->numero }}</strong></div>
                    </td>
                    <td class="bb text-center nowrap" style="vertical-align: middle;">
                        <div>Data de Emissão:</div>
                        <div class="fs-13"><strong>{{ $nota->dataEmissao }}</strong></div>
                    </td>
                </tr>
                <tr class="codigo-validacao">

...
@section('content')
    ...
    <div class="nfse">
        @php
            // Paginação MANUAL: o Chromium não repete cabeçalho alto entre páginas,
            // então quebramos os itens em blocos e desenhamos o cabeçalho completo
            // em cada bloco (idêntico ao PDF oficial). A quebra é por LINHA física
            // (pneu e conserto ocupam linha). Dois limites, medidos na nossa fonte:
            //   $linhasPorPagina -> páginas normais (só cabeçalho + itens)
            //   $linhasUltima    -> última página, que ainda leva o rodapé (cabe menos)
            // Ajuste olhando o PDF: sobrou espaço → aumente; estourou → diminua.
            ...
            // vazio logo abaixo). O conserto não é numerado, mas ocupa linha; o
            // grupo pneu+consertos nunca é partido entre páginas.
            $grupos = [];
        ...
        @foreach ($paginasItens as $itensPagina)
            ...
            <div class="pagina">
                ...
                @include('admin.layouts.partials.nota-atz-emp3-cabecalho')
    ...
    <style>
        ...
        * {
        ...
        /* Cada .pagina é uma folha física: força a quebra depois dela, menos na
               ...
               reproduzindo o comportamento do PDF oficial. */
        .nfse .pagina {
            break-after: page;
        ...
        /* ── Tabela de itens (títulos no thead, corpo no tbody) ── */
        .nfse .itens th {
            text-align: left;
            font-weight: bold;
            padding-top: 3px;

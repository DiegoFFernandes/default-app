<div class="tab-pane fade" id="pane-itens" role="tabpanel">
    {{-- Formulário de adicionar item: somente em novo ou rascunho --}}
        ...
        <div class="row mt-1 mb-1">
            ...
            <div class="col-md-2">
                <div class="form-group mb-2">
                    ...
                    <input type="number" class="form-control form-control-sm" id="qt_item" min="0.001"
            ...
            <div class="col-md-2">
                <div class="form-group mb-2">
                    ...
                    <input type="text" class="form-control form-control-sm" id="ds_unidade" maxlength="10"
                        placeholder="UN">
                </div>
            </div>
            <div class="col-md-3">
    ...
    @if ($idSolicitacao)
        ...
        {{-- Enviar para análise: somente em rascunho, solicitante sem permissão de gerenciar --}}
        @if (
            $solicitacao->ST_SOLICITACAO === 'RAS' &&

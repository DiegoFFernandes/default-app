        ...
        <form id="form-registrar-comprovante" enctype="multipart/form-data">
            ...
            <div class="row">
                <div class="col-12 col-md-6 mb-3">
                    ...
                    <select name="tp_despesa" id="tp_despesa" class="form-control select2">
                ...
                <div class="col-12 col-md-6 mb-3">
                    ...
                    <input type="date" name="dt_despesa" id="dt_despesa"
                        class="form-control" value="{{ date('Y-m-d') }}">
                </div>

                <div class="col-12 col-md-6 mb-3">
                    <label class="small" for="ds_observacao">Observação</label>
                    <textarea name="ds_observacao" id="ds_observacao" class="form-control" rows="2"
                ...
                <div class="col-12 mb-2">
                    ...
                    <small class="text-muted d-block mt-1">Use Câmera para capturar ao vivo ou Galeria para selecionar arquivos.</small>
                </div>

                <div class="col-12 mb-3" id="preview-fotos" style="display:none;">
                    <div class="d-flex justify-content-between align-items-center mb-1">
                        <label class="small mb-0">Pré-visualização <span class="badge badge-secondary" id="qtd-preview">0</span></label>

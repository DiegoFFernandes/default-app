                ...
                <div class="card card-dark card-outline card-outline-tabs">
                    <div class="card-header p-0 border-bottom-0">
                        <ul class="nav nav-tabs" id="tab-pcp" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link active" id="tab-painelPCP" data-toggle="pill" href="#painel-pcp"
                                    role="tab" aria-controls="painel-pcp" aria-selected="true">
                                    Painel PCP
                                </a>
                            </li>
                            <li class="nav-item">
                    ...
                    <div class="card-body">
                        <div class="tab-content" id="tabContentColetas">
                            <div class="tab-pane fade show active" id="painel-pcp" role="tabpanel"
                                aria-labelledby="tab-painelPCP">
                                <div class="table-responsive">
                                    <table id="pneus-lote-pcp"
                                        class="table compact table-font-small table-striped table-bordered"
                                        style="width:100%; font-size: 11px;">
                                    </table>
                                </div>
                            </div>
                            <div class="tab-pane fade" id="painel-lotesPCP" role="tabpanel"
                                aria-labelledby="tab-lotesPCP">
    ...
    <script>
        $(document).ready(function() {
            $('#pneus-lote-pcp').DataTable({
                ...
                drawCallback: function(settings) {
                    ...
                    data.each(function(rowData) {
                        ...
                        let etapa = rowData.DS_ETAPA ? rowData.DS_ETAPA.trim().toUpperCase() :
                            '';
            ...
            $('#submit-seach').on('click', function() {
                $('#pneus-lote-pcp').DataTable().ajax.reload();

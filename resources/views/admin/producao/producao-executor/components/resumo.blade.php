<div class="card shadow-sm border-0 flex-fill">
    <div class="card-header p-0 border-bottom-0">
        <ul class="nav nav-tabs grupo-tabs grupo-tabs-resumo" id="navs-tabs-resumo-{{ $painelPrincipal }}" role="tablist">
            <li class="nav-item">
    ...
    <div class="card-body">
        <div class="tab-content" id="resumo-tabs-content-{{ $painelPrincipal }}">
            <div class="tab-pane fade show active" id="resumo-setor-{{ $painelPrincipal }}" role="tabpanel" aria-labelledby="resumo-setor-tab-{{ $painelPrincipal }}" data-tabela="setorResumo-{{ $painelPrincipal }}">
            ...
            <div class="tab-pane fade" id="resumo-executor-{{ $painelPrincipal }}" role="tabpanel" aria-labelledby="resumo-executor-tab-{{ $painelPrincipal }}" data-tabela="executorResumo-{{ $painelPrincipal }}">

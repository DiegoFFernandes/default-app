                ...
                <div class="card card-success card-outline card-outline-tabs">
                    ...
                    <div class="card-header p-0 d-flex justify-content-between align-items-center">
                        <ul class="nav nav-tabs border-bottom-0" id="tabs-wpp" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link active" id="tab-conexao" data-toggle="pill" href="#pane-conexao"
                                    role="tab">
                                    <i class="fab fa-whatsapp mr-1"></i> Canal Não-oficial
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" id="tab-canal-oficial" data-toggle="pill" href="#pane-canal-oficial"
                                    role="tab">
                                    <i class="fas fa-shield-alt mr-1"></i> Canal Oficial
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" id="tab-disparos" data-toggle="pill" href="#pane-disparos"
                                    role="tab">
                                    <i class="fas fa-paper-plane mr-1"></i> Disparos Automáticos
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" id="tab-parametros" data-toggle="pill" href="#pane-parametros"
                                    role="tab">
                                    <i class="fas fa-cog mr-1"></i> Parâmetros
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" id="tab-ia" data-toggle="pill" href="#pane-ia" role="tab">
                    ...
                    <div class="card-body">
                        <div class="tab-content">
                                ...
                                <div class="row" id="row-conexoes">
                                    @foreach ($sessions as $sess)
                                        ...
                                        <div class="col-md-6 col-lg-4" id="col-sessao-{{ $session }}">
                                            ...
                                            {{-- Conectado --}}
                                            <div class="card card-outline card-success mb-3 d-none"
                                                id="card-connected-{{ $session }}">
                                                <div class="card-header text-center">
                                                    <h4 class="card-title mb-0">
                                                        <i class="fas fa-check-circle text-success mr-2"></i>WhatsApp
                                                        Conectado
                                                    </h4>
                                                </div>
                                                <div class="card-body text-center py-4">
                                                    <i class="fab fa-whatsapp text-success" style="font-size:64px;"></i>
                                                    <p class="mt-3 mb-1 font-weight-bold" style="font-size:16px;">
                                                        {{ $sess['label'] }}</p>
                                                    <p class="mb-0 text-muted" id="status-label-{{ $session }}">Sessão
                                                        ativa</p>
                                                    <button class="btn btn-sm btn-outline-danger mt-3 btn-logout-session"
                                            ...
                                            <div class="card card-outline card-warning mb-3"
                                                ...
                                                <div class="card-header text-center">
                                                    <h4 class="card-title mb-0">
                                                        ...
                                                        @else
                                                            <button
                                                                class="btn btn-xs btn-outline-danger float-right btn-excluir-conexao ml-2"
                                                                data-setor="{{ $sess['setor'] }}"
                                                                data-label="{{ $sess['label'] }}" title="Excluir conexão">
                                                    ...
                                                    <div class="btn-group btn-group-sm mt-2 mb-1" role="group">
                                                        <button type="button"
                                                            class="btn btn-outline-warning btn-modo-qrcode"
                                                            data-session="{{ $session }}">
                                                            <i class="fas fa-qrcode mr-1"></i>QR Code
                                                        </button>
                                                        <button type="button" class="btn btn-warning active btn-modo-phone"
                                                            data-session="{{ $session }}">
                                                    ...
                                                    <div id="modo-qrcode-{{ $session }}" style="display:none;">
                                                        <div id="area-loading-{{ $session }}" class="py-4">
                                                            ...
                                                            <p class="mt-2 text-muted"
                                                                id="loading-text-{{ $session }}">Verificando
                                                                conexão...</p>
                                                        </div>
                                                        <div id="area-qrcode-{{ $session }}" style="display:none;">
                                                            <p class="text-muted mb-2" style="font-size:13px;">
                                                                Abra o WhatsApp &rarr; <strong>Dispositivos
                                                                    conectados</strong> &rarr; <strong>Conectar
                                                                    dispositivo</strong>
                                                            </p>
                                                            <img id="qrcode-img-{{ $session }}" src=""
                                                                alt="QR Code" class="img-fluid rounded border"
                                                                style="max-width:220px; margin:0 auto; display:block;">
                                                            <p class="text-muted mt-2" style="font-size:12px;">
                                                                <i class="fas fa-sync-alt mr-1"></i>QR Code atualiza
                                                                automaticamente
                                                            </p>
                                                        </div>
                                                        <div id="area-erro-{{ $session }}" style="display:none;"
                                                            class="py-3">
                                                            <i class="fas fa-exclamation-triangle text-danger"
                                                                style="font-size:40px;"></i>
                                                            <p class="mt-2 text-danger"
                                                                id="erro-text-{{ $session }}">Erro ao conectar.</p>
                                                            <button class="btn btn-warning btn-sm btn-tentar-novamente"
                                                                data-session="{{ $session }}">
                                                    ...
                                                    <div id="modo-phone-{{ $session }}">
                                                        <div id="area-phone-form-{{ $session }}" class="py-3">
                                                            <p class="text-muted mb-3" style="font-size:13px;">
                                                                Abra o WhatsApp &rarr; <strong>Aparelhos vinculados</strong>
                                                                &rarr; <strong>Vincular com número de telefone</strong>
                                                            </p>
                                                            <div class="input-group mb-3"
                                                                ...
                                                                <input type="text"
                                                                    id="input-phone-{{ $session }}"
                                                                    class="form-control" placeholder="55119XXXXXXXX"
                                                                    maxlength="15">
                                                            </div>
                                                            <button class="btn btn-warning btn-gerar-codigo"
                                                                data-session="{{ $session }}">
                                                                <i class="fas fa-key mr-1"></i>Gerar Código
                                                            </button>
                                                        </div>
                                                        <div id="area-phone-loading-{{ $session }}"
                                                            style="display:none;" class="py-4">
                                                            <div class="spinner-border text-warning" role="status"></div>
                                                            <p class="mt-2 text-muted">Gerando código de pareamento...</p>
                                                        </div>
                                                        <div id="area-phone-code-{{ $session }}"
                                                            style="display:none;" class="py-3">
                                                            <p class="text-muted mb-2" style="font-size:13px;">Digite este
                                                                código no WhatsApp:</p>
                                                            <div class="display-4 font-weight-bold text-warning letter-spacing-lg"
                                                                id="pairing-code-{{ $session }}">----</div>
                                                            <p class="text-muted mt-3" style="font-size:12px;">
                                                                <i class="fas fa-clock mr-1"></i>O código expira em alguns
                                                                minutos
                                                            </p>
                                                            <button
                                                                class="btn btn-outline-warning btn-sm mt-1 btn-novo-codigo"
                                                                data-session="{{ $session }}">
                                                                <i class="fas fa-redo mr-1"></i>Gerar novo código
                                                            </button>
                                                        </div>
                                                        <div id="area-phone-erro-{{ $session }}"
                                                            style="display:none;" class="py-3">
                                                            <i class="fas fa-exclamation-triangle text-danger"
                                                                style="font-size:40px;"></i>
                                                            <p class="mt-2 text-danger"
                                                                id="phone-erro-text-{{ $session }}">Erro ao gerar
                                                                código.</p>
                                                            <button
                                                                class="btn btn-warning btn-sm btn-phone-tentar-novamente"
                                                                data-session="{{ $session }}">
                                                                <i class="fas fa-redo mr-1"></i>Tentar novamente
                                                            </button>
                                                        </div>
                                    ...
                                    <div class="col-12 {{ count($sessions) ? 'd-none' : '' }}" id="empty-conexoes">
                                        <div class="alert alert-light border text-center text-muted mb-0">
                                            ...
                                            Nenhuma conexão cadastrada. Clique em <strong>Adicionar Conexão</strong> para
                                            começar.
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="tab-pane fade" id="pane-disparos" role="tabpanel">
                                <table class="table table-sm table-hover table-bordered compact table-font-small"
                                    id="table-disparos" style="width:100%">
                                ...
                                <ul class="nav nav-pills mb-3" id="tabs-parametros" role="tablist">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link" data-toggle="pill" href="#sub-usuarios" role="tab">
                                            ...
                                            <span class="badge badge-warning ml-1 d-none"
                                                id="badge-lids-pendentes">0</span>
                                        </a>
                                    </li>
                                </ul>
                                        ...
                                        <div class="row">
                                            <div class="col-md-5">
                                                <div class="card card-outline card-success">
                                                    ...
                                                    <div class="card-body">
                                                        <p class="text-muted mb-3" style="font-size:13px;">
                                                            Quando ativado, usuários autorizados podem enviar perguntas de
                                                            negócio
                                                            via WhatsApp e receber respostas geradas por IA.
                                                        </p>
                                                        <div class="custom-control custom-switch">
                                                            <input type="checkbox" class="custom-control-input"
                                                                id="toggle-wppconnect-ia">
                                                            <label class="custom-control-label font-weight-bold"
                                                                for="toggle-wppconnect-ia">
                                        ...
                                        <div class="row">
                                            <div class="col-12">
                                                <div class="card card-outline card-primary">
                                                    <div class="card-header">
                                                        <h3 class="card-title">
                                                            <i class="fas fa-users mr-2"></i>Usuários com acesso à IA via
                                                            WhatsApp
                                                        </h3>
                                                        <div class="card-tools">
                                                            <span class="text-muted" style="font-size:12px;">
                                                    ...
                                                    <div class="card-body p-0">
                                                        <table class="table table-sm table-hover mb-0"
                                                            id="table-parametros-users">
                                                            <thead class="thead-light">
                                                                <tr>
                                                                    <th>Usuário</th>
                                                                    <th style="width:140px;">Telefone</th>
                                                                    <th style="width:220px;">WPP LID</th>
                                                                    <th style="width:90px;" class="text-center">Status
                                                                    </th>
                                        ...
                                        <div class="row" id="card-lids-pendentes" style="display:none;">
                                            <div class="col-12">
                                                <div class="card card-outline card-warning">
                                                    <div class="card-header">
                                                        <h3 class="card-title">
                                                            <i class="fas fa-link mr-2"></i>LIDs detectados — aguardando
                                                            associação
                                                        </h3>
                                                        <div class="card-tools">
                                                            <span class="text-muted" style="font-size:12px;">
                                                                Remetentes que enviaram mensagem mas ainda não estão
                            ...
                            {{-- Tab: Canal Oficial (WhatsApp Cloud API) --}}
                            <div class="tab-pane fade" id="pane-canal-oficial" role="tabpanel">
                                <div class="row">
                                    <div class="col-md-6 col-lg-4">
                                        <div class="card card-outline card-success mb-0" id="card-canal-oficial">
                                            <div class="card-header text-center">
                                                <h4 class="card-title mb-0">
                                                    <i class="fas fa-shield-alt text-success mr-2"></i>WhatsApp API Oficial
                                                </h4>
                                            </div>
                                            <div class="card-body text-center py-4" id="corpo-canal-oficial">
                                                <div class="spinner-border spinner-border-sm text-success"></div>
                                                <span class="ml-2 text-muted">Consultando a Meta...</span>
                                            </div>
                                            <div class="card-footer text-center">
                                                <a href="https://conecta.dbytech.com.br" target="_blank" rel="noopener"
                                                    class="btn btn-outline-success btn-sm">
                                                    <i class="fas fa-external-link-alt mr-1"></i>Conectar novo número
                                                </a>
                                            </div>
                                        </div>
                                    </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            function createSessionWidget(session) {
                ...
                function addSess(u) {
                    return u + (u.indexOf('?') === -1 ? '?' : '&') + 'session=' + session;
                }
                ...
                function buscarQrCode() {
                    if (tentativasQr >= MAX_QR) {
                        pararTimers();
                        mostrarErro('QR Code não gerado após ' + MAX_QR +
                            ' tentativas. Verifique se o servidor WppConnect está ativo.');
                        return;
                    }
                    tentativasQr++;
                ...
                function iniciarSessao() {
                    ...
                    tentativas = 0;
                    $.post(addSess('{{ route('wppconnect.start-session') }}'), {
                            _token: '{{ csrf_token() }}'
                        })
                        .done(function() {
                            tentativasQr = 0;
                        ...
                        $.get(addSess('{{ route('wppconnect.phone-code') }}'))
                            .done(function(res) {
                                if (res.code) {
                                    ...
                                    pararTimerPhone();
                                    $(sid('area-phone-loading')).hide();
                                    $(sid('phone-erro-text')).text(
                                        'Tempo esgotado. O código não foi gerado.');
                ...
                $(document).on('click', '.btn-modo-qrcode[data-session="' + session + '"]', function() {
                    ...
                    $('.btn-modo-phone[data-session="' + session + '"]').removeClass('active').addClass(
                        'btn-outline-warning').removeClass('btn-warning');
                    pararTimerPhone();
                    $(sid('modo-phone')).hide();
                    ...
                    $.post(addSess('{{ route('wppconnect.logout-session') }}'), {
                            _token: '{{ csrf_token() }}'
                        })
                        .always(function() {
                ...
                $(document).on('click', '.btn-modo-phone[data-session="' + session + '"]', function() {
                    if ($(this).hasClass('active')) return;
                    $(this).addClass('active').removeClass('btn-outline-warning').addClass('btn-warning');
                    $('.btn-modo-qrcode[data-session="' + session + '"]').removeClass('active').addClass(
                        'btn-outline-warning').removeClass('btn-warning');
                    pararTimers();
                ...
                $(document).on('click', '.btn-novo-codigo[data-session="' + session +
                    '"], .btn-phone-tentar-novamente[data-session="' + session + '"]',
                    function() {
                        pararTimers();
                        $(sid('area-phone-code')).hide();
                        $(sid('area-phone-erro')).hide();
                ...
                $(document).on('click', '.btn-logout-session[data-session="' + session + '"]', function() {
                    Swal.fire({
                        ...
                        $.post(addSess('{{ route('wppconnect.logout-session') }}'), {
                            ...
                            .fail(function() {
                                Swal.fire('Erro', 'Falha ao desconectar.', 'error');
                            });
                    });
                });
            ...
            function cardSessaoHtml(setor, name, label, padrao) {
                ...
                return '' +
                    ...
                    '<div class="card-header text-center">' +
                    '<h4 class="card-title mb-0"><i class="fab fa-whatsapp mr-2"></i>' + label + acaoHeader +
                    '</h4>' +
                    '<div class="btn-group btn-group-sm mt-2 mb-1" role="group">' +
                    ...
                    '<img id="qrcode-img-' + name +
                    '" src="" alt="QR Code" class="img-fluid rounded border" style="max-width:220px; margin:0 auto; display:block;">' +
                    ...
                    '" class="form-control" placeholder="55119XXXXXXXX" maxlength="15">' +
                    '</div>' +
                    ...
                    '<div class="display-4 font-weight-bold text-warning letter-spacing-lg" id="pairing-code-' +
                    name + '">----</div>' +
                ...
                $.get('{{ route('wppconnect.sessoes.disponiveis') }}')
                    .done(function(res) {
                        ...
                        res.setores.forEach(function(s) {
                            opts.push('<option value="' + s.setor + '">' + s.label +
                                '</option>');
                        });
            ...
            $('#btn-salvar-conexao').on('click', function() {
                ...
                $.post('{{ route('wppconnect.sessoes.store') }}', {
                    ...
                    parametrosCarregado =
                    false; // recarrega os selects de módulo com a nova conexão
                    Swal.fire({
                        icon: 'success',
                        title: res.success,
                        toast: true,
                    ...
                    var msg = (xhr.responseJSON && (xhr.responseJSON.errors || xhr.responseJSON
            ...
            $(document).on('click', '.btn-excluir-conexao', function() {
                ...
                Swal.fire({
                    ...
                    $.post('{{ url('wppconnect/sessoes') }}/' + setor, {
                        ...
                        $('#row-conexoes').find('[data-setor="' + setor + '"]').closest(
                            '[id^="col-sessao-"]').remove();
                        atualizarEmptyState();
                        parametrosCarregado =
                        false; // os modulos vinculados a ela voltaram para a padrao
                        Swal.fire({
                            icon: 'success',
                            title: res.success,
                            toast: true,
                        ...
                        Swal.fire('Erro', (xhr.responseJSON && xhr.responseJSON.errors) ||
                            'Falha ao excluir conexão.', 'error');
                    });
                });
            });
            ...
            $('#tabs-wpp a[data-toggle="pill"]').on('shown.bs.tab', function(e) {
                ...
                if (href === '#pane-parametros') {
                    initParametros();
                    carregarLidsPendentes();
                }
                if (href === '#pane-ia') carregarIaIntencoes();
                if (href === '#pane-canal-oficial') carregarCanalOficial();
            });

            // ============================================================
            // TAB CANAL OFICIAL — card informativo (so leitura)
            // ============================================================
            var canalOficialCarregado = false;

            function carregarCanalOficial() {
                if (canalOficialCarregado) return;
                canalOficialCarregado = true;

                $.get('{{ route('wppconnect.canal-oficial') }}')
                    .done(function(res) {
                        if (!res.conectado) {
                            $('#corpo-canal-oficial').html(
                                '<i class="fas fa-plug text-muted" style="font-size:48px;"></i>' +
                                '<p class="mt-3 mb-0 text-muted">Nenhum número conectado ainda.</p>'
                            );
                            return;
                        }
                        ...
                        var corQualidade = cores[n.quality_rating] || 'secondary';

                        $('#corpo-canal-oficial').html(
                            '<i class="fab fa-whatsapp text-success" style="font-size:56px;"></i>' +
                            '<p class="mt-3 mb-1 font-weight-bold" style="font-size:16px;">' + n
                            .display_phone_number + '</p>' +
                            '<p class="mb-1 text-muted">' + n.verified_name + '</p>' +
                            '<span class="badge badge-' + corQualidade + ' mr-1">Qualidade: ' + n
                            .quality_rating + '</span>' +
                            '<span class="badge badge-info mr-1">' + n.messaging_limit_tier +
                            '</span><br>' +
            ...
            function initParametros() {
                ...
                $.get('{{ route('wppconnect.parametros') }}').done(function(res) {
                    ...
                    $('#tbody-parametros-users').html(rows.join('') ||
                        '<tr><td colspan="5" class="text-center text-muted">Nenhum usuário com telefone cadastrado.</td></tr>'
                        );
                }).fail(function() {
                    $('#tbody-parametros-users').html(
            ...
            function renderModulosSessao(modulos, sessoes) {
                if (!modulos || !modulos.length) {
                    $('#tbody-modulos-sessao').html(
                        '<tr><td colspan="2" class="text-center text-muted py-3">Nenhum módulo configurável.</td></tr>'
                        );
                    return;
                }
                ...
                var rows = modulos.map(function(m) {
                    ...
                    (sessoes || []).forEach(function(s) {
                        ...
                        opts.push('<option value="' + s.name + '"' + sel + '>' + escHtml(s.label) +
                            '</option>');
                    });

                    // Vínculo apontando para uma conexão que não existe mais
                    var orfao = m.session && !(sessoes || []).some(function(s) {
                            return s.name === m.session;
                        }) ?
                        '<div class="text-danger mt-1" style="font-size:11px;">' +
                        '<i class="fas fa-exclamation-triangle mr-1"></i>Conexão "' + escHtml(m.session) +
                        '" não existe mais — usando a padrão.</div>' :
                        '';

                    return '<tr>' +
                        '<td>' + escHtml(m.label) + '</td>' +
                        '<td><select class="form-control form-control-sm select-modulo-sessao" data-modulo="' +
                        m.modulo + '">' +
            ...
            $(document).on('click', '.btn-toggle-wppconnect-ia', function() {
                ...
                $.post('{{ url('wppconnect/usuarios') }}/' + id + '/wppconnect-ia', {
                    ...
                    const badge = res.wpp_ia ? '<span class="badge badge-success">Ativo</span>' :
                        '<span class="badge badge-secondary">Inativo</span>';
                    ...
                    Swal.fire('Erro', xhr.responseJSON?.errors ?? 'Falha ao alterar permissão.',
                        'error');
                    btn.prop('disabled', false);
                });
            });
            ...
            function carregarLidsPendentes() {
                $.get('{{ route('wppconnect.lids-pendentes') }}')
                    .fail(function(xhr) {
                        console.error('[LIDs pendentes] erro:', xhr.status, xhr.responseText);
                    })
                    .done(function(res) {
            ...
            $(document).on('click', '.btn-associar-lid', function() {
                ...
                $.post('{{ route('wppconnect.lids-pendentes.associar') }}', {
                    ...
                    Swal.fire('Erro', xhr.responseJSON?.errors ?? xhr.responseJSON?.message ??
                        'Falha ao associar.', 'error');
                });
            });
            ...
            $(document).on('click', '.btn-toggle-intencao', function() {
                ...
                $.post('{{ url('wppconnect/ia-intencoes') }}/' + id + '/toggle', {
                    ...
                    Swal.fire('Erro', xhr.responseJSON?.errors ?? 'Falha ao alterar status.',
                        'error');
                    btn.prop('disabled', false);
                });
            });
            ...
            $('body').on('click', '.btn-reenviar', function() {
                ...
                Swal.fire({
                    ...
                    $.post('{{ url('wppconnect/disparos') }}/' + id + '/reenviar', {
                        ...
                        Swal.fire('Erro', xhr.responseJSON?.errors ?? 'Falha ao reenviar.',
                            'error');
                    });
                });
            });

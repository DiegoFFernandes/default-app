            ...
            <div class="card-body">
                ...
                <div class="col-md-12 col-xs-12 line">
                    <div class="row">
                        ...
                        <div class="col-3 col-md-3 col-xs-3 column">
                ...
                <div class="col-md-12 col-xs-12 line">
                    <div class="row">
                        ...
                        <div class="col-2 col-md-2 col-xs-2 column">
                            <p class="texto_sup">Nr Docto</p>
                            <p class="numeros_center">{{ $boleto->NR_DOC }}</p>
                        </div>

                        <div class="col-1 col-md-1 col-xs-1 column">
                        ...
                        <div class="col-3 col-md-3 col-xs-3 column" style="margin-right: 4px">
                ...
                <div class="col-md-12 col-xs-12 line_auto">
                    ...
                    <div class="col-4 col-md-4 col-xs-4 column">
                ...
                <div class="col-md-12 col-xs-12 line">
                    ...
                    <div class="col-3 col-md-3 col-xs-3 column">
                        <div class="row">
                            <div class="col-12 col-md-12 col-xs-12 line">
                ...
                <div class="col-md-12 col-xs-12 line_inv">
                    <div class="col-9 col-md-9 col-xs-9"></div>
                    <div class="col-3 col-md-3 col-xs-3">
                ...
                <div class="col-md-12 col-md-12 col-xs-12">
                    <div class="col-8 col-md-8 col-xs-8" style="padding-top: 15px">
                        {!! $codigo_barras !!}
                    </div>
                    <div class="col-4 col-md-4 col-xs-4">

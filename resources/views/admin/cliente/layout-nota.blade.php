        ...
        <div class="container">
            <div class="row">
                <div class="col-12 border border-dark rounded mb-2">
                    <div class="row">
                        <div class="col-10">
                            <div class="col-12 border-bottom border-dark vr">
                                <p class="title-nota"><strong>Prezado:</strong> {{ $data[0]->CD_PESSOA }} -
                                    {{ $data[0]->NM_PESSOA }}</p>
                                <p class="title-nota">RECEBEMOS OS ITENS CONSTANTES NO DOCUMENTO INDICADO ABAIXO</p>
                            </div>
                            <div class="col-4 border-dark vr">
                                <p class="title-nota"><strong>Data de Recebimento</strong></p>
                                <p class="ajuste_center">P</p>
                            </div>
                            <div class="col-8 border-dark vr">
                                <p class="title-nota">
                        ...
                        <div class="col-2">
                            <p class="title-nota mb-1">NOTA:<strong> {{ $data[0]->NR_NOTA }}</strong></p>
                            <p class="title-nota mb-1">RPS:<strong> {{ $data[0]->NR_RPS }}</strong></p>
            ...
            <div class="row ">
                <div class="col-12 text-center" style="background: rgb(189, 188, 188); color: rgb(0, 0, 0);">
                    <h5 class="h5-title"><strong>PRESTADOR DE SERVIÇOS</strong></h5>
                </div>
            </div>
            <div class="row align-items-center mt-1">
                ...
                <div class="col-10 align-items-center mb-1 mt-1">
                    <div class="row">
                        <div class="col-12">
                            <p class="title-nota">
                                Nome/Razão Social: {{ $data[0]->NM_EMPRESA }}
                                <span class="espaco"></span>
                                Inscrição Estadual: {{ $data[0]->NR_INSCESTEMPRESA }}
                            </p>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-12">
                            <p class="title-nota">
                                CNPJ:{{ $data[0]->NR_CNPJEMPRESA }}
                                <span class="espaco"></span>
                                Fone: {{ $data[0]->NR_FONEEMPRESA }}
                                <span class="espaco"></span>
                                Email: {{ $data[0]->DS_EMAILEMPRESA }}
                            </p>
                        </div>
            ...
            <div class="row mt-0">
                <div class="col-12 text-center" style="background: rgb(189, 188, 188); color: rgb(0, 0, 0); ">
                    <h5 class="h5-title"><strong>TOMADOR DE SERVIÇOS</strong></h5>
                </div>
            </div>
            <div class="row">
            ...
            <div class="row mt-0">
                <div class="col-12">
                    <p class="title-nota">
                        Cep: {{ $data[0]->NR_CEPPESSOA }}
                        <span class="espaco"></span>
                        Email: {{ $data[0]->DS_EMAIL }}
                        <span class="espaco"></span>
                        Fone: {{ $data[0]->NR_FONE }}
            ...
            <div class="row mt-0">
                <div class="col-12 text-center" style="background: rgb(189, 188, 188); color: rgb(0, 0, 0); ">
                    <h5 class="h5-title"><strong>DISCRIMINAÇÃO DOS SERVIÇOS PRESTADOS</strong></h5>
                </div>
            </div>
            <table class="table table-responsive table-sm" style="font-size: 13px">
                <thead>
                    <tr>
                        ...
                        <th style="width: 8%">Fogo</th>
                        <th style="width: 8%">DOT</th>
            ...
            <div class="row">
                <div class="col-4 mt-1 mb-2">
                    <p class="title-nota">Retenção ISS:
                        {{ number_format($data[0]->VL_ISSQN_RETIDO, 2, ',', '.') }}</p>
                </div>
            ...
            <div class="row">
                <div class="col-12 text-center mb-1 mt-1">
                    <h5 class="h5-title"><strong>VALOR TOTAL DA NOTA: R$
                            {{ number_format($data[0]->VL_CONTABIL, 2, ',', '.') }}</strong></h5>
                </div>
            </div>
            <div class="col-12 p-0">
                <hr style="border: 1px solid black;">
            ...
            <div class="row">
                <div class="col-12 text-center mb-1 mt-1" style="background: rgb(189, 188, 188); color: rgb(0, 0, 0); ">
            ...
            <div class="row">
                <div class="col-12 border border-dark mt-1 mb-1">
                    <div class="row mb-1 mt-1">
                        <div class="col-12">
                            <p class="title-nota">-<strong>Valor Líquido: R$
                                    {{ number_format($data[0]->VL_CONTABIL, 2, ',', '.') }}
                                </strong></p>
                        </div>
                        <div class="col-12">
                        ...
                        <div class="col-12">
                            <p class="title-nota">-<strong> RETENÇÕES: *ISS: R$
                                    {{ number_format($data[0]->VL_ISSQN_RETIDO, 2, ',', '.') }} / *IR: R$
                                    {{ number_format($data[0]->VL_IR, 2, ',', '.') }}</strong></p>
                        </div>
                        <div class="col-12">

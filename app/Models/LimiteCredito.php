    ...
    public function getLimiteCredito()
    {
        $query = "
            SELECT
                ...
                SUM(DISTINCT CREDITO.VL_CREDITOACUM) VL_CREDITO,
                SUM(DISTINCT CREDITO.VL_CREDITOACUM) - SUM(CONTAS.VL_SALDO) DISPONIVEL
            FROM NOTA N
